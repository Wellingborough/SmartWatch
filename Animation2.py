...
numSnorlaxImages = 240

while (True):
    for i in range(numSnorlaxImages):
        #
        # Load source image, get height and width
        # in pixels
        # NB - each frame is numbered using three digits, hence the
        # need for the format(i, '03d') call...
        # 0=use this as the leading char 
        # 3=fill to this minimum length
        #
        filename = "Snorlax/frame_" + format(i,'03d') + "_delay-0.03s.png"
        #print(filename)
